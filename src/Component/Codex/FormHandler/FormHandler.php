...
class FormHandler implements JsonSerializable{
	...
	/** @var \Zenit\Bundle\Codex\Interfaces\DataProviderInterface */
	protected $dataProvider;

	/** @var ItemConverterInterface */
	private $itemConverter;

	/** @var \Zenit\Bundle\Codex\Interfaces\ItemDataImporterInterface */
	private $itemDataImporter;

	/** @var \Zenit\Bundle\Codex\Component\Codex\FormHandler\FormSection[] */
	protected $sections;
